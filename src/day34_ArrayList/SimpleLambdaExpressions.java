...
public class SimpleLambdaExpressions {
    ...
    public static void main(String[] args) {
        ...
        employees.addAll(Arrays.asList("paul","paul","paul","liv","ahmed","anna"));
        employees.removeIf( p -> Collections.frequency(employees,p)>1);
        System.out.println(employees);

        ArrayList<Character>chars = new ArrayList<>();
        chars.addAll(Arrays.asList('a', '1','3','f','#','d', '!', '4' ));
