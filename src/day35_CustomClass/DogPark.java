...
public class DogPark {
    ...
    public static void main(String[] args) {
        ...
        dog5.setInfo("Duman", "Anatolian Kangal", "Large", 'M',
                "Light Golden", LocalDate.of(2018,8,1));
        dog5.getInfo();

        dog6.setInfo("Sherlock", "Beagle", "Small",
                'M', "Black, Brown and White", LocalDate.of(2014,5,9));
        dog6.getInfo();
