...
public class ArrayListPractice1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(list1.contains(10000)); // false
        System.out.println(list1.indexOf(1000)); //13
        ...
        System.out.println(list1==list2);         //   false different memory location
        System.out.println(list1.equals(list2)); // true  compare only text

        ArrayList<Integer> list3 = new ArrayList<>();
        list3.addAll(Arrays.asList(-1,-3,-4,-2,-5) );

        System.out.println(list2.equals(list3)); // false --> different index element
