...
public class StringPractice3 {
    public static void main(String[] args) {
        ...
        String r = "cava is cool programing language, I can learn cava at Cybertek school";
        r = r.replace("cav","jav");

        System.out.println(r);

        String p = "I like Java and Java Java Java Java Java Java";
        p = p.replaceFirst("Java", "C#"); // I like C#
        p = p.replaceFirst("Java", "java"); // I like C# and java Java Java....
        p = p.replace("Java", "");
