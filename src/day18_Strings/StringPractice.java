...
public class StringPractice {
    ...
    public static void main(String[] args) {
       ...
       String s3 = new String("cat");
        ...
        System.out.println(s4.equalsIgnoreCase(s5));// true, equalsIgnoreCase is not case
        ...
        char firstChar = a.charAt(0); // c
        char lastChar = a.charAt(a.length()-1);  // l
                     // last index um of a
        ...
        char secondLastChar = b.charAt(b.length()-1-1); // -1-2-3,.....
