...
public abstract class Phone { //final class can't inherit can't override
                                // can't use final keyword with final because mean to override
    public String brand, model, size,color;
    public double price;

    public Phone(String brand, String model, String size, String color, double price) {
        if (price < 0){
            throw new RuntimeException("Invalid Price, cannot be negative");       // create exception
        }                                       // throws handle temporary  exceptio
    ...
    public abstract void text(); // can't use final

    public abstract void call(); // can't use final
